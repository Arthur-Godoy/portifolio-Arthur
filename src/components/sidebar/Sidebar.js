                ...
                <div className="flip-card-back">
                    <ul className="sidebar-nav">
                        <li className="sidebar-nav-icons"> 
                            <a href="https://github.com/Arthur-Godoy" rel="opener noreferrer" target="_blank" className="fa fas fa-github fa-lg"></a>
                        </li>

                        <li className="sidebar-nav-icons">
                            <a href="https://www.linkedin.com/in/arthur-gomides-godoy-94aaa7212/" rel="opener noreferrer" target="_blank" className="fa fas fa-linkedin fa-lg"></a>
                        </li>

                        <li className="sidebar-nav-icons">
                            <a href="mailto:arthurgodoygomides@gmail.com" rel="opener noreferrer" target="_blank" className="fa fas fa-envelope fa-lg"></a>
                        </li>
                    </ul>
                </div>
